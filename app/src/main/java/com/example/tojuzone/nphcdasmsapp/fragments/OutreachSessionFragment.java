 ...
 */
public class OutreachSessionFragment extends Fragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public OutreachSessionFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView = inflater.inflate(R.layout.fragment_outreach_session, container, false);

        setupSharedPreferences();

        a = mView.findViewById(R.id.out_a);
        b = mView.findViewById(R.id.out_b);
        c = mView.findViewById(R.id.out_c);
        d = mView.findViewById(R.id.out_d);
        e = mView.findViewById(R.id.out_e);
        f = mView.findViewById(R.id.out_f);
        g = mView.findViewById(R.id.out_g);
        h = mView.findViewById(R.id.out_h);
        i = mView.findViewById(R.id.out_i);
        j = mView.findViewById(R.id.out_j);
        k = mView.findViewById(R.id.out_k);
        l = mView.findViewById(R.id.out_l);
        m = mView.findViewById(R.id.out_m);
        n = mView.findViewById(R.id.out_n);
        o = mView.findViewById(R.id.out_o);
        p = mView.findViewById(R.id.out_p);
        q = mView.findViewById(R.id.out_q);

        err = mView.findViewById(R.id.out_err);
        ...
        sendMessageBtn = mView.findViewById(R.id.outreachMsgBtn);
    ...
    protected void sendSms() {
        ...
        if (_a.isEmpty() || _b.isEmpty() || _c.isEmpty() || _d.isEmpty() || _e.isEmpty() || _f.isEmpty() || _g.isEmpty() || _h.isEmpty() || _i.isEmpty() || _j.isEmpty() || _k.isEmpty() || _l.isEmpty() || _m.isEmpty() || _n.isEmpty() || _o.isEmpty() || _p.isEmpty() || _q.isEmpty()) {
            ...
            msg = hfCode + " OS A" + _a + " B" + _b + " C" + _c + " D" + _d + " E" + _e + " F" + _f + " G" + _g + " H" + _h + " I" + _i + " J" + _j + " K" + _k + " L" + _l + " M" + _m + " N" + _n + " O" + _o + " P" + _p + " Q" + _q;
